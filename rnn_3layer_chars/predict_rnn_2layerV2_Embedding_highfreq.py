...
def predict():
    num_layer = 3
    with open(os.path.join(abspath, 'dataset', r"tangshi_rnn2layerV2_highfreq.json"), 'r') as obj:
...
if __name__=="__main__":
    frequency = 7000
    pth = os.path.join(abspath, "models", 'tangshi_rnn2layerV2_embedding_highfreq_%d.pkl'%frequency)
    predict()