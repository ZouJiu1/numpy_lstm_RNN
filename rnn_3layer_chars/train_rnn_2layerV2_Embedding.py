...
def preprocess():
    jsonpth = os.path.join(abspath, 'dataset', r"tangshi_rnn2layerV2.json")
    ...
    if not os.path.exists(jsonpth):
        with open(os.path.join(abspath, "dataset", r"tangshi_rnn2layerV2.json"), 'w') as obj:
...
def train():
    ...
    # with open(os.path.join(abspath, r"dataset", r"tangshi_rnn2layer.json"), 'w') as obj:
    #     json.dump({"id2char":id2char, 'char2id':char2id}, obj, indent=2, separators=(",", ":"))
    ...
    for e in range(iters):
        ...
        if (e + 1) % savemodel == 0:
            ...
            model.append(e)
            with open(os.path.join(abspath, "models", 'tangshi_rnn2layerV2_embedding_char.pkl'), 'wb') as obj:
...
if __name__=="__main__":
    pretrained_model = os.path.join(abspath, "models", 'tangshi_rnn2layerV2_embedding_char.pkl')
    train()