...
def preprocess():
    jsonpth = os.path.join(abspath, 'dataset', r"tangshi_rnn2layer_dynamic_highfreq.json")
    ...
    for e in range(iters):
        ...
        for i in range(len(all_content) - 1):
            ...
            if (e + 1) % savemodel == 0:
                ...
                model.append(e)
                with open(os.path.join(abspath, "models", 'tangshi_rnn2layer_embedding_dynamic_highfreq_char.pkl'), 'wb') as obj:
...
if __name__=="__main__":
    frequency= 1000
    pretrained_model = os.path.join(abspath, "models", 'tangshi_rnn2layer_embedding_dynamic_highfreq_char.pkl')
    train()