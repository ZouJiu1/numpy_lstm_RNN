...
def predict():
    num_layer = 3
    with open(os.path.join(abspath, 'dataset', r"tangshi_lstm2layer_dynamic.json"), 'r') as obj:
...
if __name__=="__main__":
    pth = os.path.join(abspath, "models", 'tangshi_lstm2layer_embedding_dynamic.pkl')
    predict()