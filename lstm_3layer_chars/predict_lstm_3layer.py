...
def predict():
    num_layer = 3
    with open(os.path.join(abspath, 'dataset', r"tangshi_rnn3layer.json"), 'r') as obj:
    ...
    for j in range(length):
        hidden_0 = rnn_layer0.forward(first_inputs, hidden_0)
...
if __name__=="__main__":
    pth = os.path.join(abspath, 'tangshi_rnn3layer.pkl')
    predict()